...
import {logout, postJoin, getJoin, getLogin, postLogin} from "../controllers/userController";  //경로에 join, login, logout를 가져오고 있음
...
globalRouter.get(routes.login, getLogin);     // express 에서 제공하는 REST API .get()이라는 메소드를 이용해 url 경로를 지정하고 있다. 즉
